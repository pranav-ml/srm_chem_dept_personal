  ...
  <body>
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <li><a href="analysis.php">Analysis</a></li>';
        ...
        if($_SESSION["type"]=="superuser"){   //changed autosorbiqequests.php to autosorbiqrequests.php on line 194
            ...
            <option value="fuelcellrequests.php">Fuel Cell Analyser and RRDE Instruments Requests</option>
          </select></li>
