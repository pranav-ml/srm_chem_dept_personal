...
<body style="background-color:#f4f6f9;">
  ...
  <nav class="top-bar" data-topbar role="navigation">
      ...
      <ul class="right">
        ...
        echo'<li class="active"><a href="contact.php">Contact</a></li>'; // Echo Dump edit wisely
          if(isset($_SESSION['username'])){
...
?>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        <div class="scrollit">
        <p>
          <!-- For general queries write to <><br> -->
          
For specific queries contact the following:<br>
          ...
          <table>
            ...
            <tr>
              <td>
              Autosorb iQ- Chemisorption (&Physisorption) Gas sorption Analyzer 
              </td>
              <td>
                In-charge:<br>
                Dr. Renjith Sasimohanan Pillai<br>
                E-Mail: renjiths@srmist.edu.in<br>
                Mobile: 9895952625<br><br>
