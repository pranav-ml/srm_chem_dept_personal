    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <ul class="right">
        ...
        if($_SESSION['type']=="autosorbiqadmin")
          {
            echo '<li><a href="autosorbiqrequests.php">Autosorb iQ Requests</a></li>
            <li><a href="autosorbiq_cancellation.php">Autosorb iQ Cencellation Requests</a></li>
      ...
      <div>';
        ...
        //$name="Autosorb iQ-C-AG/MP/XR";
         //$result = $mysqli->query("SELECT * FROM users cross join orders WHERE user_id=id AND status=0 AND product_name='$name'");
           echo '<h1>Autosorb iQ-C-AG/MP/XR Booking Requests</h1>';
          if($a->num_rows) {
            ...
            echo '<td style="word-break:break-all;">'.$lq_result->analysis_type.'</td>';
            echo '<td>'.$lq_result->degassing_temp.'</td>';
            echo '<td style="word-break:break-all;">'.$lq_result->degassing_condition.'</td>';
            echo '<td style="word-break:break-all;">'.$lq_result->additional_details.'</td>';
            echo '</tr>';
            echo '</table>';
            //third table
            echo '<table class="mytable">';
            echo '<tr>';
            echo '<td>';
            echo '<form action ="autosorbiqrequests.php" method=POST>
          ...
          {
            echo '<p>No New Autosorb iQ-C-AG/MP/XR Booking as of now!</p>';
          }
